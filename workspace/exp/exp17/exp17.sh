...
######### the same as exp 13 except Change Strategy: baseline method, apply to all row and col penalty to all layers. Moreover, change shs_decay_rate to 0.0002 ########
...
HPARAMS=transformer_base_single_gpu_shs_train_no_ssl_embedding_exp17
