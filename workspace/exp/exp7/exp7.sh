######### transformer ########
# last week, we realize model initialization with 
# different models on mnist (from single weight matrix 
# to several sub-matrix weight). 
# This week, we move this method to transformer in exp7.
